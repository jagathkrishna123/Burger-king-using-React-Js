  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 max-w-full p-2 md:justify-center md:items-center gap-4 mb-[40px]'>
        <div className='flex flex-row gap-[40px] relative flex-1'>
            ...
            <button className='bg-[#EE284B] rounded-[9px]  font-oswald font-normal w-[100px] h-[28px] text-white items-center justify-center flex flex-row gap-2 mt-3 absolute bottom-20 left-9 transition-transform duration-300 hover:-translate-y-2'>
